...
parser.add_argument("--teacher_saved_model", default='0817_CIFAR2CUB_5w10s_cross_CXs_outerKD_Teacher', type=str)
parser.add_argument("--student_saved_model", default='0817_CIFAR2CUB_5w10s_cross_CXs_outerKD_Student', type=str)
...
save_name = f"{args.dataset_name.split('_')[0]}2{args.dataset_name2.split('_')[0]}_{args.test_way}w{args.test_shot}s_{config['save_name_tag']}_{args.kd_mode}KD" 
