...
class DistortImageFolder(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        save_path = os.path.join(args.corruption_data_path, args.mode, self.idx_to_class[target] )
        #save_path = corruption_data_path + self.idx_to_class[target] 
        ...
        save_path = save_path_[0] + '-' + self.method.__name__ + '-' + str(self.severity) + '.' + save_path_[1]
...
def save_distorted(method=gaussian_noise):
    ...
    for severity in range(1, 6):
        ...
        distorted_dataset = DistortImageFolder(
                            root = os.path.join(args.clean_data_path, args.mode), 
                            method = method, 
                            severity = severity,
